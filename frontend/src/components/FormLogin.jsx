        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-30 lg:px-8">
            ...
            <div style={{
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="email" class="block text-sm/6 font-medium text-black">Endereço de email</label>
                        <div class="mt-2">
                            <input id="email"
                            ...
                            focus:outline-indigo-600 sm:text-sm/6" placeholder="Digite seu email" />
                        </div>
                    </div>

                    <div>
                        <div class="flex items-center justify-between">
                            <label for="password" class="block text-sm/6 font-medium text-black">Senha</label>
                            <div class="text-sm">
                                <a href="#" class="font-semibold text-black-500">Esqueceu a senha?</a>
                            </div>
                        </div>
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-500">
                    Não possui cadastro?
                    <a href="/register" class="font-semibold text-black">Crie aqui!</a>
                </p>
            </div>
        </div>
